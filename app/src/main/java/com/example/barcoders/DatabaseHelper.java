...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    private static final String databaseName = "barcode.db"; // 데이터베이스 이름
    private static final String tableName = "barcode"; // 테이블 이름
        ...
        try{
            ...
            if (mCursor != null){
                ...
                while(mCursor.moveToNext()){
                    ...
                    barcode.setBarcode(mCursor.getString(0));
                    barcode.setItem(mCursor.getString(1));
                    barcode.setMaterial(mCursor.getString(2));
